CREATE OR REPLACE FUNCTION t_getnormal_from3points_array(point1 double precision[] , point2 double precision[] , point3 double precision[] ) RETURNS double precision[] AS $$
