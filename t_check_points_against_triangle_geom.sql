	...
	*/
	drop function t_checkPointsAgainstTrianglegeom;
	CREATE OR REPLACE FUNCTION  t_checkPointsAgainstTriangleGeom(
		v1 double precision[], 
		v2 double precision[], 
		v3 double precision[], 
		...
		RETURNS 
		TABLE(x double precision,y double precision,z double precision )
	...
	*/
	...
	--										)
					...
					where 
						--PC_Intersects(  test.patch,cg.pa  )
	...
	---				
					 ...
					 loop
						...
						BEGIN
						--raise notice 'PROBANDO pointintet';
						...
						*/
						...
						IF intet.isin then 
							...
							return query select points_bbox.x::double precision x, points_bbox.y::double precision y ,points_bbox.z::double precision z ;
